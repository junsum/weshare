		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
            ...
            <span class="icon-bar"></span>
					...
					<a class="navbar-brand" href="index.html">
						<h1><img src="images/logo.png" alt="" /></h1></a>
				</div>
			...
			<div class="drop-navigation drop-navigation">
				<ul class="nav nav-sidebar">
					...
					<!--
                            ...
                            -->
					<li>
						<a href="adv.html" class="sub-icon"><span class="glyphicon glyphicon-home glyphicon-hourglass" aria-hidden="true"></span>广告</a>
					</li>
			...
			<div class="main-grids">
				<div class="recommended">
					<div class="recommended-grids english-grid">
						...
						<c:forEach items="${page.advs}" var="adv">
							<div class="col-md-2 resent-grid recommended-grid sports-recommended-grid">
								...
								<div class="resent-grid-info recommended-grid-info">
									<h5><a href="single.html" class="title">广告标题${adv.title}</a></h5>
									<p class="author">
										<a href="#" class="author">视频作者:${adv.userid}</a>
									</p>
									<p class="views">热度:${adv.hot}</p>
								</div>
							</div>
						</c:forEach>
