			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="shows.html" class="user-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>WE Share</a></li>
				...
				<div class="col-sm-10 show-grid-left main-grids">
					<div class="recommended">
						...
						<c:if test="${page.totalPage>0}">
								<c:forEach items="${page.videos}" var="video">
									<!-- 视频模块 -->
									<div class="col-md-2 resent-grid recommended-grid show-video-grid">
										<!-- 视频图片链接 -->
										<div class="resent-grid-img recommended-grid-img">
											<a href="${app}/video/findVideoById/${video.videoId}"><img src="${video.imageUrl}" alt="" /></a>
											<!-- 视频时长 -->
										...
										<div class="resent-grid-info recommended-grid-info">
											<h5>
												<a href="${app}/video/findVideoById/${video.videoId}" class="title">${video.videoName}</a>
											</h5>
											<p class="author">
												<a href="${app}/author/findUserByName/${user.userName}" class="author">${user.userName}</a>
											</p>
											<p class="views">${video.videoHot}</p>
										</div>
									</div>
								</c:forEach>
							</c:if>		
