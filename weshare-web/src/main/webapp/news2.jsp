			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					<li><a href="index.html" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>We Share</a></li>
					...
					<div class="recommended-grids english-grid">
						...
						<c:if test="${page.totalPage>0}">
							<div id="videos_content">
								<c:forEach items="${page.video}" var="video">
						<div class="col-md-2 resent-grid recommended-grid sports-recommended-grid">
									<div class="resent-grid-img recommended-grid-img">
									<a href="${app}/video/findVideoById/${video.videoId}">
									...
									<h5><a href="${app}/video/findVideoById/${video.videoId}" class="title">${video.videoName}</a></h5>
									<p class="author"><a href="${app}/video/findVideoById/${user.userName}" class="author">${user.userName}</a></p>
									<p class="hots">${video.videoHot}</p>
									</div>
						</div>
								</c:forEach>
							</div>
